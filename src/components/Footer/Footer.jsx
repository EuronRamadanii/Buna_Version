...
import CC from "../../assets/all-images/CC.png";
          ...
          <Col lg="3" md="4" sm="6">
            <div className="mb-4">
              ...
              <p className="office__info">
                Bremer Str. 11 80807 München Deutschland
              </p>
              <p className="office__info">Phone: +49 (0)89 35477460</p>
